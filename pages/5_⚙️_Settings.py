...
if st.session_state.get("dark_mode", True):
    ...
    <style>
        ...
        h1, h2, h3, h4, h5, h6, p, div, span, label, .stMarkdown { color: #fafafa !important; }
    ...
    <style>
        ...
        h1, h2, h3, h4, h5, h6, p, div, span, label, .stMarkdown { color: #1a1a1a !important; font-weight: 500; }
        @media (max-width: 768px) { .stApp { padding: 0.5rem; } }
        .stTextInput > div > div > input {
...
with st.sidebar:
    ...
    if st.button(f"{theme_icon} {theme_text}", key="theme_toggle_settings"):
